    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7d7ef5d2-4272-4421-be96-f35d797e68ad", null, "Usuário", "USUÁRIO" },
                    { "d2f38565-24e1-42c8-8971-9d496ba4725b", null, "Administrador", "ADMINISTRADOR" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "05daeb44-7dc8-402c-a21f-87ffdd0742ed", 0, "b9b5424c-a14a-4a1f-be81-db1835195d54", "admin@gcook.com", true, false, null, "ADMIN@GCOOK.COM", "ADMIN", "AQAAAAIAAYagAAAAEJcy/Aq8CRHEaMfPMzYIb5El8w48R4wrkcPPPy9hGubG7oneiQbVLaHfqTmgoMPk6g==", null, false, "c738ff16-482b-4fb3-97e2-1c0e9e3d60c1", false, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7d7ef5d2-4272-4421-be96-f35d797e68ad", "05daeb44-7dc8-402c-a21f-87ffdd0742ed" },
                    { "d2f38565-24e1-42c8-8971-9d496ba4725b", "05daeb44-7dc8-402c-a21f-87ffdd0742ed" }
                });

            migrationBuilder.InsertData(
                table: "Usuario",
                columns: new[] { "UsuarioId", "DataNascimento", "Foto", "Nome" },
                values: new object[] { "05daeb44-7dc8-402c-a21f-87ffdd0742ed", new DateTime(2006, 11, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "/img/usuarios/avatar.png", "Guilherme Henrique Domingues" });
